...
const Controls = ({
  ...
  const handleGenerationSpeedChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setControls({ ...controls, generationSpeed: parseInt(e.target.value) });
  };

  const handleSimulateNetworkIssueChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <select 
              ...
              className="w-full px-3 py-2 pr-8 text-sm bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:border-zinc-500 dark:text-zinc-100 appearance-none"
            >
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="w-4 h-4 text-zinc-600 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded focus:ring-zinc-500 focus:ring-2"
              />
              <label htmlFor="networkIssue" className="text-sm font-medium text-zinc-900 dark:text-zinc-100">
